"""
Whisper Audio Transcriber GUI with in-memory pipeline.
"""
# pylint: disable=line-too-long, missing-docstring, broad-exception-caught, invalid-name
...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """Decode audio to in-memory numpy array (16kHz mono)."""
...
class WhisperEngine:
    ...
    def transcribe_chunks(
        ...
        total_chunks = math.ceil(len(audio_data) / chunk_samples) if len(audio_data) > 0 else 1
