...
class AudioPreprocessor:
    """Handles audio conversion and memory-based processing."""

    @staticmethod
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """Converts audio to 16kHz mono float32 in memory using FFmpeg pipes."""
        silence_filter = (
        ...
        # Capture stdout into memory; using copy() ensures the buffer is writable
...
class WhisperEngine:
    ...
    def transcribe_chunks(
        ...
        """Transcribes audio in chunks to optimize memory and handle long recordings."""
        all_segments = []
        full_text = []
