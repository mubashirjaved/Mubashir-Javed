...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """
        Converts input audio to normalized float32 PCM in-memory.
        """
        ...
        # Convert buffer to numpy array and normalize to [-1, 1]
...
class WhisperEngine:
    ...
    def detect_language(self, audio: np.ndarray) -> Tuple[str, float]:
        """
        Detects language from the first 30s of the audio NumPy array.
        """
    ...
    def transcribe_chunks(
        ...
        """
        Transcribes audio in chunks using NumPy slicing to avoid temporary files.
        """
        all_segments = []
        full_text = []
        sample_rate = 16000
        ...
        for i in range(total_chunks):
            ...
            progress_cb(i / total_chunks, f"Transcribing chunk {i + 1}/{total_chunks}")
