...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """Loads audio via FFmpeg pipe into a normalized float32 NumPy array."""
        ...
        # Using stdout=subprocess.PIPE and stderr=subprocess.PIPE for observability
...
class WhisperEngine:
    ...
    def transcribe_chunks(
        ...
        for idx in range(total_chunks):
            ...
            chunk_offset = (idx * samples_per_chunk) / 16000
