...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """
        Pipes FFmpeg output directly to a numpy array (16kHz, mono, float32).
        Eliminates disk I/O and intermediate WAV files.
        """
        ...
        # Convert s16le (int16) to float32 normalized to [-1, 1] as expected by Whisper
...
class WhisperEngine:
    ...
    def detect_language(self, audio: np.ndarray) -> Tuple[str, float]:
        """Detects language from a numpy array of audio."""
    ...
    def transcribe_chunks(
        ...
        """
        Transcribes audio in chunks using numpy slicing to avoid disk I/O.
        """
        all_segments = []
        full_text = []
        sample_rate = 16000
