...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """FFmpeg pipe to memory: f32le, 16kHz mono."""
        ...
        # Using explicit pipes as per Bolt's performance journal
...
class WhisperEngine:
    ...
    def transcribe_chunks(
        ...
        for idx in range(num_chunks):
            ...
            end_sample = min((idx + 1) * chunk_samples, len(audio_array))
...
class TranscriberGUI:
    ...
    def _run_transcription(self) -> None:
        ...
        try:
            ...
            self._set_progress(0.2, f"Starting transcription in {chunk_seconds}s chunks")
