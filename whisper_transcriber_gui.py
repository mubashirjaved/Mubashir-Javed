...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """
        Uses FFmpeg to read audio directly into a NumPy array (16kHz mono float32).
        """
        ...
        # Pipe raw PCM S16LE data from stdout
...
class WhisperEngine:
    ...
    def transcribe_chunks(
        ...
        merged_text = " ".join(seg.get("text", "").strip() for seg in all_segments).strip()
        if not timestamps:
