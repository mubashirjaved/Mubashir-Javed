...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """Loads and resamples audio directly to memory as a float32 NumPy array."""
...
class WhisperEngine:
    ...
    def detect_language(self, audio: np.ndarray) -> Tuple[str, float]:
        """Detects language directly from a NumPy array."""
    ...
    def transcribe_chunks(
        ...
        for idx in range(total_chunks):
            ...
            end_idx = min((idx + 1) * chunk_size, len(audio))
            chunk_data = audio[start_idx:end_idx]
...
class TranscriberGUI:
    ...
    def _run_transcription(self) -> None:
        ...
        try:
            ...
            self._log(f"Processing in {chunk_sec}s chunks")
            ...
            result = engine.transcribe_chunks(
                ...
                progress_cb=lambda p, msg: self._set_progress(0.12 + 0.83 * p, msg),
            )
