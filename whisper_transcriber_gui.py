...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """
        Processes audio via FFmpeg and pipes raw PCM data directly into a NumPy array.
        Returns float32 normalized array at 16kHz mono.
        """
        ...
        # Use stdout=subprocess.PIPE and stderr=subprocess.PIPE to avoid ValueError with capture_output=True
        # and ensure FFmpeg errors are observable.
...
class WhisperEngine:
    ...
    def detect_language(self, audio: np.ndarray) -> Tuple[str, float]:
        """Detects language from pre-loaded in-memory audio array."""
    ...
    def transcribe_chunks(
        ...
        """Transcribes audio using in-memory NumPy slicing for chunking."""
        all_segments = []
        full_text = []
