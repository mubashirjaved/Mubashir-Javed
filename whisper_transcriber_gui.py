...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """Decodes audio using FFmpeg and returns a normalized float32 NumPy array."""
...
class WhisperEngine:
    ...
    def detect_language(self, audio: np.ndarray) -> Tuple[str, float]:
        """Detects the language of the provided audio array."""
    ...
    def transcribe_chunks(
        ...
        """Transcribes audio in chunks to handle long files efficiently without disk I/O."""
        all_segments = []
        full_text = []
