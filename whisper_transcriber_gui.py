...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """Preprocesses audio and loads it directly into a NumPy array."""
...
class WhisperEngine:
    """Wraps OpenAI Whisper for in-memory transcription."""
    ...
    def detect_language(self, audio: np.ndarray) -> Tuple[str, float]:
        """Detects the spoken language from an audio array."""
    ...
    def transcribe_chunks(
        ...
        """Transcribes audio using in-memory chunking and merging."""
        all_segments = []
        full_text = []
        sample_rate = 16000
...
class TranscriberGUI:
    ...
    def _run_transcription(self) -> None:
        ...
        try:
            ...
            self._set_progress(0.18, "Starting transcription")
