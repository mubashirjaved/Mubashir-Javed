...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """Pipes FFmpeg PCM output directly into a numpy array (16kHz mono float32)."""
        ...
        # Use stdout=subprocess.PIPE; stderr=subprocess.PIPE to avoid ValueError with capture_output.
...
class WhisperEngine:
    ...
    def detect_language(self, audio: np.ndarray) -> Tuple[str, float]:
        """Detects language from an in-memory numpy array, avoiding redundant FFmpeg calls."""
    ...
    def transcribe_chunks(
        ...
        num_chunks = math.ceil(len(audio_data) / chunk_samples)
...
class TranscriberGUI:
    ...
    def _run_transcription(self) -> None:
        ...
        try:
            ...
            self._set_progress(0.2, "Transcribing in chunks")
