...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """
        Convert input media to 16kHz mono float32 PCM and return as NumPy array.
        Uses in-memory pipe to avoid disk I/O.
        """
...
class TranscriberGUI:
    ...
    def _run_transcription(self) -> None:
        ...
        try:
            ...
            chunks = [audio_array[i : i + samples_per_chunk] for i in range(0, len(audio_array), samples_per_chunk)]
