...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """Pipes audio from FFmpeg directly into a NumPy float32 array."""
    ...
    @staticmethod
    def chunk_audio_in_memory(audio_array: np.ndarray, chunk_seconds: int) -> List[np.ndarray]:
        """Slices a NumPy audio array into smaller chunks."""
        sample_rate = 16000
...
class WhisperEngine:
    ...
    def transcribe_chunks(
        ...
        """Transcribes multiple audio chunks (NumPy arrays) and merges results."""
        all_segments = []
        full_text = []
...
class TranscriberGUI:
    ...
    def _run_transcription(self) -> None:
        ...
        try:
            ...
            chunk_s = self.chunk_var.get()
            chunks = AudioPreprocessor.chunk_audio_in_memory(audio_array, chunk_s)
