...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """
        Preprocesses audio using FFmpeg and pipes float32 PCM data directly to memory.
        """
        ...
        # stdout=subprocess.PIPE is used to capture the PCM data.
        # stderr=subprocess.PIPE captures logs and errors.
...
class WhisperEngine:
    ...
    def detect_language(self, audio: np.ndarray) -> Tuple[str, float]:
        """
        Detects the language of the audio from a NumPy array.
        """
    ...
    def transcribe_chunks(
        ...
        """
        Transcribes the full audio by slicing it into chunks in memory.
        """
        all_segments = []
        full_text = []
...
class TranscriberGUI:
    ...
    def _run_transcription(self) -> None:
        ...
        try:
            ...
            self._set_progress(0.15, "Transcribing")
