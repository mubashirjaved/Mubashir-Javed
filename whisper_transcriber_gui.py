...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """Decodes audio to 16kHz mono float32 PCM in-memory using FFmpeg."""
        ...
        # We use stdout=subprocess.PIPE to capture the raw PCM data
...
class WhisperEngine:
    ...
    def transcribe_chunks(
        ...
        """Transcribes audio in chunks using in-memory slicing for performance."""
        all_segments = []
        full_text = []
