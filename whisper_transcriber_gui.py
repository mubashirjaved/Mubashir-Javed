...
class AudioPreprocessor:
    ...
    def load_audio(input_path: str, smart_silence: bool) -> np.ndarray:
        """
        Loads audio using ffmpeg and pipes it into a numpy array.
        Eliminates intermediate disk I/O.
        """
        ...
        # Use subprocess.run with capture_output for better performance and safety
...
class TranscriberGUI:
    ...
    def _run_transcription(self) -> None:
        ...
        try:
            ...
            self._set_progress(0.05, "Loading audio into memory")
