...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """Decodes audio to 16kHz mono float32 NumPy array using FFmpeg piping."""
        ...
        # Using stdout=PIPE to capture raw PCM data; stderr=PIPE to avoid console noise/capture errors
...
class WhisperEngine:
    ...
    def transcribe_chunks(
        ...
        """Transcribes audio in-memory using slicing."""
        sample_rate = 16000
