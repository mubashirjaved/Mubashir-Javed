...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """Decode audio to 16kHz mono float32 NumPy array using FFmpeg pipe."""
        ...
        # Convert to float32 and normalize to [-1, 1] to match whisper.load_audio
...
class WhisperEngine:
    ...
    def detect_language(self, audio: np.ndarray) -> Tuple[str, float]:
        """Detect language from pre-loaded NumPy audio array."""
    ...
    def transcribe_chunks(
        ...
        """Transcribe audio in-memory using NumPy slicing for chunking."""
        all_segments = []
        full_text = []
...
class TranscriberGUI:
    ...
    def _run_transcription(self) -> None:
        ...
        try:
            ...
            self._log(f"Starting in-memory transcription with {chunk_seconds}s chunks")
