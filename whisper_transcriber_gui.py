...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        ...
        # Use stdout=subprocess.PIPE to capture raw float32 PCM data
...
class WhisperEngine:
    ...
    def detect_language(self, audio: np.ndarray) -> Tuple[str, float]:
        """Detects language from in-memory NumPy audio array."""
    ...
    def transcribe_chunks(
        ...
        """Transcribes full audio in memory by slicing into chunks."""
        all_segments = []
        full_text = []
...
class TranscriberGUI:
    ...
    def _run_transcription(self) -> None:
        ...
        try:
            ...
            # In-memory preprocessing (returns float32 NumPy array)
