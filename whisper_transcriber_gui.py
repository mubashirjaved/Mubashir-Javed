...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """
        Preprocesses audio using FFmpeg and pipes it directly into a NumPy array.
        Returns a float32 array normalized to [-1, 1] at 16kHz mono.
        """
        silence_filter = (
        ...
        # In-memory processing avoids disk I/O and temporary files.
