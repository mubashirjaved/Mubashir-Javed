...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """
        Uses FFmpeg to preprocess audio to 16kHz mono float32 PCM and load into a numpy array.
        Eliminates temporary files and redundant disk I/O.
        """
        ...
        # Pipe PCM data directly to stdout and capture it
        result = subprocess.run(cmd, capture_output=True, check=True)
        # Convert raw bytes to float32 array; .copy() ensures we own the memory
...
class WhisperEngine:
    ...
    def transcribe_chunks(
        ...
        num_chunks = math.ceil(total_len / samples_per_chunk)
        ...
        for idx in range(num_chunks):
            ...
            end_sample = min((idx + 1) * samples_per_chunk, total_len)
...
class TranscriberGUI:
    ...
    def _run_transcription(self) -> None:
        ...
        try:
            ...
            # In-memory preprocessing eliminates temporary WAV files and disk I/O latency
            ...
            # transcribe_chunks now handles in-memory slicing
