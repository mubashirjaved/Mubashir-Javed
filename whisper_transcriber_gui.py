...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """
        ⚡ Bolt: In-memory preprocessing.
        Pipes raw PCM from FFmpeg directly into a NumPy array, eliminating disk I/O.
        """
        silence_filter = (
...
class WhisperEngine:
    ...
    def detect_language(self, audio: np.ndarray) -> Tuple[str, float]:
        """⚡ Bolt: Direct NumPy array language detection."""
    ...
    def transcribe_chunks(
        ...
        """
        ⚡ Bolt: In-memory slicing and transcription.
        Eliminates redundant FFmpeg calls and disk I/O.
        """
        all_segments = []
        full_text = []
        sample_rate = 16000
