...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        ...
        # Pipe PCM data directly into a NumPy array, eliminating temporary files.
...
class WhisperEngine:
    ...
    def detect_language(self, audio: np.ndarray) -> Tuple[str, float]:
        # whisper.pad_or_trim expects a numpy array or torch tensor.
    ...
    def transcribe_chunks(
        ...
        for idx, chunk in enumerate(chunks):
            ...
            # Use dynamic chunk offset for accurate timestamps across all segments.
