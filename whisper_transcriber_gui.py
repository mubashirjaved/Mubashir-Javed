...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """
        Loads audio from input_path, converts to 16kHz mono float32 PCM via FFmpeg pipe.
...
class WhisperEngine:
    ...
    def transcribe_chunks(
        ...
        """
        Transcribes audio in chunks to save VRAM and maintain responsiveness.
        Performs in-memory chunking via numpy slicing.
        """
        all_segments = []
        full_text = []
        sample_rate = 16000
