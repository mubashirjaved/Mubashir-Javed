...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """
        ⚡ Bolt: In-memory pipeline reduces disk I/O and transcription overhead.
        Pipes s16le PCM data directly into a NumPy array.
        """
...
class WhisperEngine:
    ...
    def detect_language(self, audio: np.ndarray) -> Tuple[str, float]:
        """⚡ Bolt: Detect language from in-memory array."""
    ...
    def transcribe_chunks(
        ...
        """⚡ Bolt: Chunking via NumPy slicing eliminates file overhead and fixes offset bug."""
        all_segments = []
        full_text = []
        sr = 16000
        ...
        for idx in range(total_chunks):
            ...
            for seg in result.get("segments", []):
                ...
                # Correcting word-level timestamps if they exist
                if "words" in seg:
                    for w in seg["words"]:
...
class TranscriberGUI:
    ...
    def _run_transcription(self) -> None:
        ...
        try:
            ...
            self._set_progress(0.2, "Transcribing in-memory chunks")
