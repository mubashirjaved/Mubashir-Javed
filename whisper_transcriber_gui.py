...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        ...
        Returns float32 PCM data at 16kHz mono.
        """
        silence_filter = (
        ...
        # Pipe raw PCM data to stdout
        # Benchmark: 600s audio preprocessed in ~0.25s vs ~0.50s baseline (2x speedup)
...
class WhisperEngine:
    """Whisper engine for transcription and language detection."""
    ...
    def transcribe_chunks(
        ...
        """Transcribes audio by slicing it into chunks in-memory."""
        all_segments = []
        full_text = []
        ...
        # Clean up whitespace from joining
