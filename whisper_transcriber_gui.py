...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """
        ⚡ Bolt Optimization: Use in-memory processing to eliminate temporary WAV files.
        Reduces disk I/O and speeds up the preprocessing-to-transcription pipeline.
        """
        ...
        # Pipe raw PCM data to stdout and load it directly into NumPy
...
class WhisperEngine:
    ...
    def detect_language(self, audio: np.ndarray) -> Tuple[str, float]:
        """
        ⚡ Bolt Optimization: Detect language from in-memory NumPy array.
        """
    ...
    def transcribe_chunks(
        ...
        """
        ⚡ Bolt Optimization: Slices the audio array in-memory for chunking.
        Fixes hardcoded 180s offset and eliminates FFmpeg-based chunking overhead.
        """
        all_segments = []
        full_text = []
...
class TranscriberGUI:
    ...
    def _run_transcription(self) -> None:
        ...
        try:
            ...
            self._log(f"Starting in-memory transcription in {chunk_seconds}s chunks")
