...
class AudioPreprocessor:
    """Handles audio loading and preprocessing into NumPy format."""
    @staticmethod
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """Preprocess audio to a float32 NumPy array using FFmpeg."""
        ...
        # Convert s16le PCM to float32 and normalize
    ...
    def chunk_audio(audio: np.ndarray, chunk_seconds: int) -> List[np.ndarray]:
        """Split NumPy audio array into chunks of specified length."""
        sample_rate = 16000
