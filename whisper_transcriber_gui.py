...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        ...
        # Use stdout=PIPE to capture the PCM data; stderr is also piped to avoid clutter but help on error
...
class TranscriberGUI:
    ...
    def _run_transcription(self) -> None:
        ...
        try:
            ...
            self._log(f"Transcribing in-memory with {chunk_seconds}s chunks")
