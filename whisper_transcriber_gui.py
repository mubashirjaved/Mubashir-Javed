...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """
        Uses FFmpeg to decode audio directly into a float32 numpy array.
        """
        silence_filter = (
        ...
        # numpy.frombuffer returns a read-only view. We copy it to ensure it's writable
        # as some torch/whisper operations might expect writable tensors.
