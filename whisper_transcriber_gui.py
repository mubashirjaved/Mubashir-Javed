...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        ...
        # Using stdout=PIPE to capture PCM data, stderr=PIPE to capture log output
        # Calling .copy() to ensure array is writable as np.frombuffer returns a read-only view
