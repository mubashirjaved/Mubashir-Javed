...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        """Preprocesses audio to a mono 16kHz float32 NumPy array."""
    ...
    def chunk_audio_in_memory(audio_data: np.ndarray, chunk_seconds: int) -> List[np.ndarray]:
        """Splits the audio NumPy array into chunks of specified duration."""
        sample_rate = 16000
...
class WhisperEngine:
    ...
    def detect_language(self, audio_data: np.ndarray) -> Tuple[str, float]:
        """Detects language from a NumPy array of audio data."""
    ...
    def transcribe_chunks(
        ...
        """Transcribes audio chunks in memory and merges the results."""
        all_segments = []
        full_text = []
