...
class AudioPreprocessor:
    ...
    def preprocess_to_memory(input_path: str, smart_silence: bool) -> np.ndarray:
        ...
        Eliminates disk I/O and temporary WAV files.
        """
        ...
        # Using pipe:1 (stdout) to stream raw float32 PCM data
...
class WhisperEngine:
    ...
    def transcribe_chunks(
        ...
        Optimizes performance by eliminating FFmpeg-based disk chunking.
        """
        sample_rate = 16000
